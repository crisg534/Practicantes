...
#     description: "programador requerido para turbo pascal", city_id: city.id, skill_list: "turbo pascal,",
#      wanted_skills: "C,")
#   Offer.create(enterprise_id: e2.id, name: "porgramador requerido", 
#     description: "programador requerido para ruby on rails", city_id: city.id, 
